...
## Ix Architects melee defender. Structurally a Soldier with amber identity.
## faction_id = 2 (player-aligned). Combat stats live on the scene's components:
## StatComponent.max_health = 150, MovementComponent.speed = 100,
## CombatComponent.attack_damage = 14.
...
@export var sprite_asset: String = "ix_lattice_guard"
...
func _on_attack_landed(_target: Node2D, _damage: float) -> void:
