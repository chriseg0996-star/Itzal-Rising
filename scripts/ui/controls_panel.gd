...
const BINDINGS: Array[Array] = [
	...
	["Right click", "Move / harvest / build / work farm"],
	...
	["B / T / Y / M / F / H / U / P", "Build shortcuts (or use the command card with a villager selected)"],
	["Select villager / building", "Contextual command card appears bottom-right (tabs, queue, research)"],
