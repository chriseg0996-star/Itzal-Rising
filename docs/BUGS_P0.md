...
| ID | Severidad | Descripción | Repro | Estado |
|----|-----------|-------------|-------|--------|
| P1-001 | P1 | `skirmish_setup.gd` no llama `ObjectiveManager.reset()` al iniciar partida. | Campaña → skirmish | Abierto |
...
| `gate_audio.gd` | **PASS** | `GATE_AUDIO_OK` |
